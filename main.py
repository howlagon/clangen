...
async def main():
    global find_spec, finished_loading
    ...
    if get_version_info().is_source_build:
        ...
        if get_version_info().version_number == VERSION_NAME and not is_web:
    ...
    while 1:
        ...
        if not is_web and pygame.mixer.music.get_busy() and not music_manager.muted:
