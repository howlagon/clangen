...
class MakeClanScreen(Screens):
            ...
            if len(self.members) == 0:
                self.elements["background"].set_image(
                    pygame.transform.scale(
                        image_load("resources/images/pick_clan_screen/clan_none_light.png").convert_alpha(),
                        (1600, 1400)))
                self.elements['next_step'].disable()
            elif len(self.members) == 1:
                self.elements["background"].set_image(
                    pygame.transform.scale(
                        image_load("resources/images/pick_clan_screen/clan_one_light.png").convert_alpha(),
                        (1600, 1400)))
                self.elements['next_step'].disable()
            elif len(self.members) == 2:
                self.elements["background"].set_image(
                    pygame.transform.scale(
                        image_load("resources/images/pick_clan_screen/clan_two_light.png").convert_alpha(),
                        (1600, 1400)))
                self.elements['next_step'].disable()
            elif len(self.members) == 3:
                self.elements["background"].set_image(
                    pygame.transform.scale(
                        image_load("resources/images/pick_clan_screen/clan_three_light.png").convert_alpha(),
                        (1600, 1400)))
                self.elements['next_step'].disable()
            elif 4 <= len(self.members) <= 6:
                self.elements["background"].set_image(
                    pygame.transform.scale(
                        image_load("resources/images/pick_clan_screen/clan_four_light.png").convert_alpha(),
                        (1600, 1400)))
                self.elements['next_step'].enable()
                ...
                self.elements["background"].set_image(
                    pygame.transform.scale(
                        image_load("resources/images/pick_clan_screen/clan_full_light.png").convert_alpha(),
                        (1600, 1400)))
    ...
    def open_choose_background(self):
        ...
        # image_load(self.get_camp_art_path(1)).convert_alpha(), visible=False)
